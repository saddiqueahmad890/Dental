            ...
            <div class="card">
                ...
                <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 align-content-center">
                                        ...
                                        @if(request()->isFilterActive)
                                            <a href="{{ route('prescriptions.index') }}" class="btn btn-secondary mt-4">@lang('Clear')</a>
                                        @endif
                                    </div>
                                </div>
                            </form>
                    ...
                    <table class="table table-striped" id="laravel_datatable">
                        <thead>
                            <tr>
                                <th style="text-wrap:nowrap;">Exam Investigation</th>
                                <th>Doctor</th>
                                <th>Patient</th>
                                <th>@lang('Date')</th>
                        ...
                        <tbody>
                            @foreach ($prescriptions as $prescription)
                                <tr>
                                <td><span style="text-wrap:nowrap;">{{ $prescription->examinvestigations->examination_number ?? ' '  }}</span></td>
